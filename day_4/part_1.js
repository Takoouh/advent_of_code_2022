...
const resolvePuzzle = (data) => {
  ...
  formattedData.forEach((assignements) => {
    ...
    const isOverlaping =
      (splittedAssignements[0][0] >= splittedAssignements[1][0] && splittedAssignements[0][1] <= splittedAssignements[1][1]) ||
      (splittedAssignements[1][0] >= splittedAssignements[0][0] && splittedAssignements[1][1] <= splittedAssignements[0][1]);
